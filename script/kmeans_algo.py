...
plt.xlabel(y[0])
plt.ylabel(y[2])
plt.scatter(centers[:, 0], centers[:, 2], marker='o', c='white', alpha=1, s=500)
...
plt.xlabel(y[1])
plt.ylabel(y[3])
plt.scatter(centers[:, 1], centers[:, 3], marker='o', c='white', alpha=1, s=500)
for i, c in enumerate(centers):
...
plt.xlabel(y[4])
plt.ylabel(y[9])
plt.scatter(centers[:, 4], centers[:, 9], marker='o', c='white', alpha=1, s=500)
for i, c in enumerate(centers):
...
plt.xlabel(y[5])
plt.ylabel(y[10])
plt.scatter(centers[:, 5], centers[:, 10], marker='o', c='white', alpha=1, s=500)
for i, c in enumerate(centers):
